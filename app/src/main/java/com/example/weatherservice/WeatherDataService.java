...
public class WeatherDataService {
    ...
    public static final String QUERY_FOR_CITY_NAME = "https://www.metaweather.com/api/location/";
    Context context;
    String cityID;
...
//
    ...
    public void getCityForecastByName(String cityName,ForecastListener forecastListener) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    forecastListener.onResponse(weatherReportModels);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                forecastListener.onError("ERROR");
            }
        }
        );
        ...
        //get consolidated weather object

        //get each item in array and assign
    }
 }
